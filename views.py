...
#AVALIAR
    def avaliacao(self):
        ...
        #print(quantidade_cromossomos_1)
            #print(caracteristicas_grupo, caracteristicas_grupo[g])
        for i in range(len(caracteristicas)):
            ...
            if(self.cromossomo[i]=='1'):
                ...
                if quantidade_cromossomos_1 != self.limite_integrante_grupo:
                    ...
                    if self.caracteristicas[i] == self.grupo:
                        self.nota_avaliacao += self.caracteristicas[i].count(self.grupo )+ 0.35
                        #print(self.caracteristicas[i], caracteristicas_grupo[g])
                    else:
                        self.nota_avaliacao = 0.1      
